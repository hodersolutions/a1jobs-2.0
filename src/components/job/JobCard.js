            ...
            <Link to={ url } className='card-container'>
                <div className='a1-card row align-items-start job-item border-bottom pb-3 mb-3 pt-3'>
                    ...
                    <div className='col-md-3 text-left'>
                        <p className='meta'><LocationOnIcon className='img-align' color='disabled' /> <strong>{this.props.job.state},</strong></p>
                        <p className='meta'>&emsp;&ensp;&nbsp;<strong>{this.props.job.district},</strong></p>
                        <p className='meta'>&emsp;&ensp;&nbsp;<strong>{this.props.job.town}</strong></p>                        
                    </div>
