        ...
        if(errors === '') {
            ...
            .then(response => {
                    if(response.status === 'success') {
                        notify.show(response.message + '. Please Sign In.', 'success', parseInt(NotificationsTimeOut), 'green');
                    }
                    else {
                        notify.show(response.message, 'error', parseInt(NotificationsTimeOut), 'red');
                    }
                    this.setState({
                        loading: false
                    });
            ...
            notify.show(errors, 'error', parseInt(NotificationsTimeOut), 'red');
    }
